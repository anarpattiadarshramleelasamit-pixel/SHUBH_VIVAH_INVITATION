...
<head>
    ...
    <style>
        ...
        /* Enhanced Colorful Glowing Details */
        .glowing-details-main {
            color: var(--primary-color); /* Gold base */
            text-shadow: 0 0 10px var(--primary-color), 0 0 20px rgba(255, 215, 0, 0.7); /* Strong Gold Glow */
            font-weight: bold;
            font-size: 1.25rem; /* Slightly larger for emphasis */
            animation: text-glow-gold 3s infinite alternate;
        }
        .glowing-details-pink {
            color: var(--secondary-color); /* Deep Pink base */
            text-shadow: 0 0 8px var(--secondary-color), 0 0 15px rgba(255, 20, 147, 0.6); /* Deep Pink Glow */
            font-weight: bold;
            font-size: 1.15rem; /* Slightly smaller than gold for hierarchy */
            animation: text-glow-pink 3.5s infinite alternate;
        }
        .glowing-details-cyan {
            color: #00FFFF; /* Cyan for Bal Manuhar */
            text-shadow: 0 0 6px #00FFFF, 0 0 12px rgba(0, 255, 255, 0.5);
            font-style: italic;
            font-size: 1rem;
            animation: text-glow-cyan 4s infinite alternate;
        }
        ...
        /* Keyframes for different colored glows */
        ...
        @keyframes text-glow-pink {
            0% { text-shadow: 0 0 8px var(--secondary-color); }
            100% { text-shadow: 0 0 20px var(--secondary-color), 0 0 30px rgba(255, 20, 147, 0.8); }
        }
        @keyframes text-glow-cyan {
            0% { text-shadow: 0 0 6px #00FFFF; }
            100% { text-shadow: 0 0 15px #00FFFF, 0 0 25px rgba(0, 255, 255, 0.7); }
        }
    </style>
</head>
<body class="p-4">
    ...
    <div id="app" class="max-w-xl w-full p-6 md:p-10 rounded-xl decorative-card text-center">
        ...
        <!-- Step 2: Invitation Display and Quiz/RSVP --><div id="step2" class="hidden">
            ...
            <!-- Main Invitation Text (Updated to Glowing Colorful) --><div class="text-left bg-white bg-opacity-5 p-4 rounded-xl mb-6 border border-yellow-500">
                <p class="text-xl mb-4 font-semibold glowing-details-main">
                    मैं श्री सुरेन्द्र कुमार यादव एवं श्रीमती ऊषा यादव
                </p>
                <p class="leading-relaxed mb-4 glowing-details-main">
                ...
                <!-- Wedding Details (Updated to Glowing Pink) --><div class="space-y-2 mt-6 p-3 border-t border-b border-gray-600">
                    <p class="glowing-details-pink">कार्यक्रम दिनांक: 22 नवंबर 2025 (शनिवार)</p>
                    <p class="glowing-details-pink">
                ...
                <!-- Bal Manuhar (Updated to Glowing Cyan) --><p class="mt-6 text-center glowing-details-cyan">
